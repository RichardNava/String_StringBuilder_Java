...
public class String_StringBuilder { // String es inmutable - StringBuilder es mutable
	...
	public static void main(String[] args) {
		...
		// (argumento)
		p(texto.concat("Y además eres muy feo."));
		...
		// Método repeat(int count) repetimos el texto concatenandolo el número de veces que le digamos por argumento
		...
		// STRINGBUILDER
		//StringBuilder sbTexto2 = new StringBuilder("Que la fuerza te acompañe");
		
		StringBuilder sbTexto = new StringBuilder(sc.nextLine());
		p(sbTexto);
		// Método append(Dato nombreDato) añade al final de nuestro String el argumento que le pasemos (Concatena).
		sbTexto.append(" fin.");
		p(sbTexto);
		// Método insert(int pos, Dato nombreDato) introduce en la posición especificada el dato que le pasamos
